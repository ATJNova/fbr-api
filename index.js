// index.js — FBR Forwarder Proxy (Updated)
...
// Build axios config, forward Authorization exactly
function buildAxiosConfig(incomingAuthHeader) {
  ...
  // Mutual TLS (if FBR requires client cert)
...
// Get FBR endpoint URL based on action & environment
